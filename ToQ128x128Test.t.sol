...
contract RationalToQ128x128Test is Test {
    ...
    function testFuzz_toQ128x128_BoundedInputs(uint128 numerator, uint128 denominator) public pure {
        ...
        RationalToQ128x128.UnsignedRational memory frac =
            RationalToQ128x128.UnsignedRational({numerator: numerator, denominator: denominator});
    ...
    function testFuzz_toQ128x128_SignedAgainstFullMath(int128 numerator, int128 denominator) public {
        vm.assume(denominator != 0);
        ...
        RationalToQ128x128.Rational memory frac =
            RationalToQ128x128.Rational({numerator: numerator, denominator: denominator});
    ...
    function testFuzz_toQ128x128_SignedSignHandling(
        ...
        uint256 unsignedResult = RationalToQ128x128.toQ128x128U(uint256(absNumerator), uint256(absDenominator));
    ...
    function testFuzz_ZeroNumerator(uint256 denominator) public pure {
        ...
        RationalToQ128x128.UnsignedRational memory frac =
            RationalToQ128x128.UnsignedRational({numerator: 0, denominator: denominator});
    ...
    function testFuzz_NumeratorEqualsDenominator(uint128 value) public pure {
        ...
        RationalToQ128x128.UnsignedRational memory frac =
            RationalToQ128x128.UnsignedRational({numerator: value, denominator: value});
    ...
    function calculateExpectedUnsigned(uint256 numerator, uint256 denominator) external pure returns (uint256) {
    ...
    function externalToQ128x128Unsigned(uint256 numerator, uint256 denominator) external pure returns (uint256) {
        RationalToQ128x128.UnsignedRational memory frac =
            RationalToQ128x128.UnsignedRational({numerator: numerator, denominator: denominator});
    ...
    function externalToQ128x128Signed(int256 numerator, int256 denominator) external pure returns (int256) {
        RationalToQ128x128.Rational memory frac =
            RationalToQ128x128.Rational({numerator: numerator, denominator: denominator});
        return frac.toQ128x128();
    }
    ...
    function test_KnownValues() public pure {
        ...
        RationalToQ128x128.UnsignedRational memory half =
            RationalToQ128x128.UnsignedRational({numerator: 1, denominator: 2});
        ...
        RationalToQ128x128.UnsignedRational memory two =
            RationalToQ128x128.UnsignedRational({numerator: 2, denominator: 1});
        ...
        RationalToQ128x128.UnsignedRational memory threeFourths =
            RationalToQ128x128.UnsignedRational({numerator: 3, denominator: 4});
    ...
    function test_SignedKnownValues() public pure {
        // Test -1/2 = -0.5
        RationalToQ128x128.Rational memory negHalf = RationalToQ128x128.Rational({numerator: -1, denominator: 2});
        ...
        RationalToQ128x128.Rational memory halfNegDenom = RationalToQ128x128.Rational({numerator: 1, denominator: -2});
        ...
        RationalToQ128x128.Rational memory bothNeg = RationalToQ128x128.Rational({numerator: -1, denominator: -2});
    ...
    function test_UnsignedOverflowBoundary() public {
        ...
        RationalToQ128x128.UnsignedRational memory maxSafe =
            RationalToQ128x128.UnsignedRational({numerator: maxSafeNumerator, denominator: 1});
    ...
    function test_SignedOverflowBoundary() public {
        ...
        RationalToQ128x128.Rational memory maxSafe =
            RationalToQ128x128.Rational({numerator: maxSafeNumerator, denominator: 1});
    ...
    function test_INT256_MIN_EdgeCase() public pure {
        ...
        RationalToQ128x128.Rational memory minWithLargeDenom =
            RationalToQ128x128.Rational({numerator: minInt, denominator: int256(uint256(1 << 129))});
        ...
        RationalToQ128x128.Rational memory minAsDenom = RationalToQ128x128.Rational({numerator: 1, denominator: minInt});
    ...
    function test_SignedZeroNumerator() public pure {
        ...
        RationalToQ128x128.Rational memory zeroPosD = RationalToQ128x128.Rational({numerator: 0, denominator: 12345});
        assertEq(zeroPosD.toQ128x128(), 0, "0 / positive should be 0");

        // Zero numerator with negative denominator
        RationalToQ128x128.Rational memory zeroNegD = RationalToQ128x128.Rational({numerator: 0, denominator: -12345});
    ...
    function test_RoundingTowardZero_Negative() public pure {
        ...
        RationalToQ128x128.Rational memory negFrac = RationalToQ128x128.Rational({numerator: -5, denominator: 3});
    ...
    function test_VeryLargeDenominator() public pure {
        ...
        RationalToQ128x128.UnsignedRational memory verySmall =
            RationalToQ128x128.UnsignedRational({numerator: 1, denominator: type(uint128).max});
        ...
        RationalToQ128x128.UnsignedRational memory roundsToZero =
            RationalToQ128x128.UnsignedRational({numerator: 1, denominator: type(uint256).max});
    ...
    function test_CheapPath_Prod1Zero() public pure {
        ...
        RationalToQ128x128.UnsignedRational memory small =
            RationalToQ128x128.UnsignedRational({numerator: smallNumerator, denominator: denominator});
    ...
    function test_SystematicDenominatorVariation() public pure {
        ...
        for (uint256 i = 1; i <= 10; i++) {
            ...
            RationalToQ128x128.UnsignedRational memory frac =
                RationalToQ128x128.UnsignedRational({numerator: fixedNumerator, denominator: denominator});
    ...
    function test_ExactInt256Max() public pure {
        ...
        RationalToQ128x128.Rational memory atMax =
            RationalToQ128x128.Rational({numerator: int256(numerator), denominator: int256(denominator)});
    ...
    function test_RemainderHandling() public pure {
        ...
        // 7/3 = 2.333...
        RationalToQ128x128.UnsignedRational memory withRemainder =
            RationalToQ128x128.UnsignedRational({numerator: 7, denominator: 3});
    ...
    function test_ComplexDivisionPath() public pure {
        ...
        RationalToQ128x128.UnsignedRational memory complex =
            RationalToQ128x128.UnsignedRational({numerator: numerator, denominator: denominator});
    ...
    function test_SignedRoundsToZero() public pure {
        ...
        RationalToQ128x128.Rational memory tiny =
            RationalToQ128x128.Rational({numerator: -1, denominator: int256(uint256(type(uint128).max))});
    ...
    function test_UnsignedJustInsideBoundary() public pure {
        ...
        RationalToQ128x128.UnsignedRational memory justInside =
            RationalToQ128x128.UnsignedRational({numerator: maxSafeNumerator - 1, denominator: 1});
    ...
    function test_MaxDividedByMax() public pure {
        RationalToQ128x128.UnsignedRational memory maxByMax =
            RationalToQ128x128.UnsignedRational({numerator: type(uint256).max, denominator: type(uint256).max});
    ...
    function test_SignedJustInsideBoundary() public pure {
        ...
        // One less than max safe
        RationalToQ128x128.Rational memory justInside =
            RationalToQ128x128.Rational({numerator: maxSafeNumerator - 1, denominator: 1});
    ...
    function test_BothOperandsINT256_MIN() public pure {
        RationalToQ128x128.Rational memory both =
            RationalToQ128x128.Rational({numerator: type(int256).min, denominator: type(int256).min});
    ...
    function test_NegOneDivINT256_MIN() public pure {
        RationalToQ128x128.Rational memory frac =
            RationalToQ128x128.Rational({numerator: -1, denominator: type(int256).min});
    ...
    function test_VerySmallPositiveMagnitude() public pure {
        RationalToQ128x128.Rational memory tiny =
            RationalToQ128x128.Rational({numerator: 1, denominator: int128(type(int128).max)});
    ...
    function test_SignCombosLargeDenominators() public pure {
        ...
        // Positive / Positive
        RationalToQ128x128.Rational memory posPos = RationalToQ128x128.Rational({numerator: 1, denominator: largeDenom});
        int256 resultPosPos = posPos.toQ128x128();
        assertEq(resultPosPos, 0, "+1 / +2^254 should round to 0");

        // Negative / Positive
        RationalToQ128x128.Rational memory negPos =
            RationalToQ128x128.Rational({numerator: -1, denominator: largeDenom});
        int256 resultNegPos = negPos.toQ128x128();
        assertEq(resultNegPos, 0, "-1 / +2^254 should round to 0");

        // Positive / Negative
        RationalToQ128x128.Rational memory posNeg =
            RationalToQ128x128.Rational({numerator: 1, denominator: -largeDenom});
        int256 resultPosNeg = posNeg.toQ128x128();
        assertEq(resultPosNeg, 0, "+1 / -2^254 should round to 0");

        // Negative / Negative
        RationalToQ128x128.Rational memory negNeg =
            RationalToQ128x128.Rational({numerator: -1, denominator: -largeDenom});
    ...
    function test_Prod1Zero_VariousDenominators() public pure {
        ...
        for (uint256 i = 0; i < denominators.length; i++) {
            RationalToQ128x128.UnsignedRational memory frac =
                RationalToQ128x128.UnsignedRational({numerator: smallNumerator, denominator: denominators[i]});
    ...
    function test_Prod1Positive_NoOverflow() public pure {
        ...
        RationalToQ128x128.UnsignedRational memory case1 =
            RationalToQ128x128.UnsignedRational({numerator: uint256(1) << 200, denominator: uint256(1) << 73});
        ...
        RationalToQ128x128.UnsignedRational memory case2 =
            RationalToQ128x128.UnsignedRational({numerator: uint256(1) << 150, denominator: uint256(1) << 50});
    ...
    function test_DenominatorAtOverflowBoundary() public {
        ...
        RationalToQ128x128.UnsignedRational memory justSafe =
            RationalToQ128x128.UnsignedRational({numerator: numerator, denominator: prod1 + 1});
    ...
    function test_LargePowerOfTwoFactors() public pure {
        // Test 3 * 2^128
        RationalToQ128x128.UnsignedRational memory case1 =
            RationalToQ128x128.UnsignedRational({numerator: uint256(9) << 150, denominator: uint256(3) << 128});
        uint256 result1 = case1.toQ128x128();
        ...
        // Test 5 * 2^64
        RationalToQ128x128.UnsignedRational memory case2 =
            RationalToQ128x128.UnsignedRational({numerator: 1000, denominator: uint256(5) << 64});
        uint256 result2 = case2.toQ128x128();
        ...
        RationalToQ128x128.UnsignedRational memory case3 =
            RationalToQ128x128.UnsignedRational({numerator: uint256(7) << 200, denominator: uint256(7) << 200});
    ...
    function test_PureOddDenominators() public pure {
        ...
        for (uint256 i = 0; i < oddDenoms.length; i++) {
            RationalToQ128x128.UnsignedRational memory small =
                RationalToQ128x128.UnsignedRational({numerator: 1000, denominator: oddDenoms[i]});
        ...
        for (uint256 i = 0; i < oddDenoms.length; i++) {
            ...
            RationalToQ128x128.UnsignedRational memory large =
                RationalToQ128x128.UnsignedRational({numerator: largeNum, denominator: oddDenoms[i]});
    ...
    function test_DenominatorOne() public pure {
        ...
        RationalToQ128x128.UnsignedRational memory frac =
            RationalToQ128x128.UnsignedRational({numerator: numerator, denominator: 1});
    ...
    function test_MixedFactorizations() public pure {
        // Test 15 * 2^64
        RationalToQ128x128.UnsignedRational memory case1 =
            RationalToQ128x128.UnsignedRational({numerator: uint256(15) << 100, denominator: uint256(15) << 64});
        uint256 result1 = case1.toQ128x128();
        ...
        // Test 255 * 2^128
        RationalToQ128x128.UnsignedRational memory case2 =
            RationalToQ128x128.UnsignedRational({numerator: uint256(255) << 150, denominator: uint256(255) << 128});
        uint256 result2 = case2.toQ128x128();
